<?php
// barbiere/tutte_notifiche.php - Pagina per visualizzare tutte le notifiche del barbiere
session_start();
...
// Ottieni tutte le notifiche del barbiere (senza limite)
$notifications = getNotifications('barbiere', $_SESSION['barbiere_id'], 100);

// Quando la pagina viene caricata, segna tutte le notifiche come lette
$conn = connectDB();
$stmt = $conn->prepare("UPDATE notifiche SET letto = 1 WHERE barbiere_id = ? AND letto = 0");
...
<head>
    ...
    <title>Notifiche - BarberBook Admin</title>
