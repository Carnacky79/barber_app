<?php
// barbiere/includes/header.php - Header per le pagine barbiere
...
if (isBarbiere()) {
    $unread_notifications_count = countUnreadNotifications('barbiere', $_SESSION['barbiere_id']);
}
?>
<!DOCTYPE html>
<html lang="it">
...
<header>
    <div class="header-container">
        <div class="logo">
            <a href="dashboard.php">BarberBook Admin</a>
        </div>
